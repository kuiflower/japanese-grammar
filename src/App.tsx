    ...
    <Layout>
      <Suspense fallback={<RouteFallback />}>
        <Routes>
          ...
          <Route path="/practice/:bank/:level" element={<PracticeSession mode="practice" />} />
